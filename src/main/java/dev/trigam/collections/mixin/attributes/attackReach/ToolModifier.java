...
public class ToolModifier extends ToolItem implements Vanishable, ITool {
	...
	public ToolModifier(float toolBaseDamage, float attackSpeed, ToolMaterial material, TagKey<Block> effectiveBlocks, Item.Settings settings) {
