...
public class ItemModifyInit {
	...
	public static void modifyItems() {
		// COMBAT REACH
		// Sword
		((IReachTool) Items.WOODEN_SWORD).setAttackReach(3);
		((IReachTool) Items.STONE_SWORD).setAttackReach(3);
		((IReachTool) Items.IRON_SWORD).setAttackReach(3);
		((IReachTool) Items.GOLDEN_SWORD).setAttackReach(3);
		((IReachTool) Items.DIAMOND_SWORD).setAttackReach(3);
		((IReachTool) Items.NETHERITE_SWORD).setAttackReach(3);
		// Pickaxe
